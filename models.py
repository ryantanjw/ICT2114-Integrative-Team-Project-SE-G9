...
class Form(db.Model):
    ...
    process = db.Column(db.models.TextField(("")), nullable=True)
...
class Hazard(db.Model):
    ...
    remarks = db.Column(db.models.TextField(("")), nullable=True)
...
class Risk(db.Model):
    ...
    existing_risk_control = db.Column(db.models.TextField(("")), nullable=True)
    additional_risk_control = db.Column(db.models.TextField(("")), nullable=True)
...
class RA_team_member(db.Model):
    ...
    # Define fields
    RA_team_id = db.Column(db.Integer, db.ForeignKey('RA_team.RA_team_id'), nullable=False)
